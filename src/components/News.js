...
export class News extends Component {
  ...
  async componentDidMount(){
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=26152cba7e2c4243a4bd9b561d022a26&page=1&pageSize=${this.props.pageSize}`
  ...
  handlePrevious=async()=>{
    ...
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=26152cba7e2c4243a4bd9b561d022a26&page=${this.state.page-1}&pageSize=${this.props.pageSize}`
    this.setState({loading:true})
    let data=await fetch(url)
    let parsedData=await data.json()
